...
void
compute_gold (float *vector_a, float *vector_b, 
              float *vector_c, int num_elements)  /* The reference soution */
{
    for (int i = 0; i < num_elements; i++)
...
void
compute_using_sse_intrinsics (float *vector_a, float *vector_b, 
                              float *vector_c, int num_elements)  /* Calculate using SSE compiler intrinsics. */
{
